                      ...
                      <div key={section.id || sectionIndex} id={section.id}>
                        ...
                        {section.content && section.content.split('\n\n').map((paragraph, pIndex) => (
                          <p key={pIndex} className="mb-4">
                            {paragraph.split(/(<link[^>]*>.*?<\/link>)/).map((part, linkIndex) => {
                              ...
                              // Handle external links with rel="nofollow"
                  ...
                  {cities.map((city) => {
                    ...
                    return (
                      <Link
                        ...
                        onClick={(e) => {
                          if (isCurrentCity) {
                            // Wenn aktuelle Stadt: nur nach oben scrollen
                            e.preventDefault();
                            window.scrollTo({ top: 0, behavior: 'smooth' });
                          } else {
                            // Andere Städte: Navigation + Scroll nach oben
                            setTimeout(() => {
                              window.scrollTo({ top: 0, behavior: 'smooth' });
                            }, 100);
                          }
