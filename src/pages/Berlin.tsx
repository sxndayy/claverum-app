...
const Berlin = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Soweit aus Unterlagen, Protokollen und Fotos erkennbar werden Hinweise zu Dach, Fassade, Treppenhaus und zentraler Haustechnik gegeben. Die Instandhaltungsrücklage und geplante Maßnahmen aus Eigentümerversammlungen werden berücksichtigt."
    },
    {
      question: "Wie schnell erhalte ich den Bericht für meine Immobilie in Berlin?",
      answer: "Der Bericht wird in der Regel bis zum nächsten Werktag bereitgestellt. Die Bearbeitungszeit beträgt voraussichtlich 48 Stunden ab vollständiger Übermittlung aller Unterlagen und Fotos."
    },
    {
  ...
  return (
    <>
      <SEO 
        title="Gutachter Hauskauf Berlin – Bauschadensanalyse & Kaufberatung | bauklar.org"
        description="Unabhängige Bauschadensanalyse für Hauskauf in Berlin. Gründerzeit, Neubau, Eigentumswohnung – digitale Prüfung mit verständlichem Bericht in 48h. Jetzt starten."
        canonical="/berlin"
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-xl text-text-200 mb-8 leading-relaxed">
                  Unabhängige Bewertung von Altbau, Neubau und Eigentumswohnungen in Berlin. Digitale Analyse mit verständlichem Bericht in 48 Stunden – ohne Vor-Ort-Termin.
                </p>
                ...
                <div className="mb-12 rounded-lg overflow-hidden shadow-soft">
                  <img
                    src="/Berlin-test.jpeg"
                    alt="Mehrfamilienhaus mit klassischer Fassade – Bauschadensanalyse für Hauskauf"
                    width={1600}
                    height={900}
                    loading="eager"
                  ...
                  <div className="space-y-12 text-text-200 leading-relaxed">
                    ...
                    <div id="typische-gebaeude-berlin">
                      ...
                      <div className="mb-8">
                        ...
                        <p className="mb-4">
                          <strong>Protokolle der Eigentümerversammlungen</strong> dokumentieren geplante Maßnahmen, bereits diskutierte Mängel und Beschlussfassungen. Diese Unterlagen sollten sorgfältig geprüft werden. Häufig werden größere Sanierungen bereits Jahre im Voraus besprochen, bevor der Beschluss gefasst wird.
                        </p>
                        <p className="mb-4">
                    ...
                    <div id="ablauf">
                      ...
                      <p className="mb-4">
                        Die Bauschadensanalyse erfolgt vollständig digital und erfordert keine Terminvereinbarung. Sie laden Fotos der Immobilie sowie vorhandene Unterlagen wie Grundrisse, Energieausweise oder Protokolle von Eigentümerversammlungen hoch. Ergänzend geben Sie relevante Informationen zu Baujahr, Bauweise, erkannten Mängeln und geplanten Nutzungen an.
                      </p>
                      <p className="mb-4">
                      ...
                      <p className="mb-4">
                        Der Bericht wird voraussichtlich bis zum nächsten Werktag bereitgestellt. Die Bearbeitungszeit beträgt in der Regel 48 Stunden ab vollständiger Datenübermittlung. Der Bericht steht als PDF zum Download bereit und kann für Bankgespräche oder Verhandlungen mit Verkäufern genutzt werden.
                      </p>
                      <p>
                    ...
                    <div id="was-sie-erhalten">
                      ...
                      <p className="mb-4">
                        Der Bericht stellt den Zustand der Immobilie strukturiert und nachvollziehbar dar. Wesentliche Bauteile wie Tragwerk, Dach, Fassade, Fenster, Haustechnik und Innenausbau werden einzeln bewertet. Jedes Bauteil erhält eine Einschätzung seines aktuellen Zustands und seiner voraussichtlichen Restnutzungsdauer.
                      </p>
                      <p className="mb-4">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-lg text-text-200 mb-10 leading-relaxed">
                  Der Bericht liegt voraussichtlich bis zum nächsten Werktag vor und verschafft Ihnen Klarheit für Ihre Kaufentscheidung. Sie können ihn für Verhandlungen mit Verkäufern nutzen, Ihrer Bank vorlegen oder als Grundlage für die Sanierungsplanung verwenden. Starten Sie jetzt die Bewertung und treffen Sie Ihre Kaufentscheidung auf fundierter Basis.
                </p>
                ...
                <div className="grid md:grid-cols-4 gap-4 mb-10">
                  ...
                  <div className="bg-background rounded-lg p-4 shadow-soft">
                    ...
                    <p className="text-sm font-medium text-text-100">48h Bearbeitungszeit</p>
                  </div>
                  <div className="bg-background rounded-lg p-4 shadow-soft">
                ...
                <p className="text-sm text-text-200 mt-4">
                  Bericht i. d. R. bis nächster Werktag – klar, verständlich, unabhängig.
                </p>
              </div>
            </div>
          </section>
