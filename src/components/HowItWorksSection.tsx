            ...
            {steps.map((step, index) => (
              <div key={index} className="step relative text-center">
                <div className="relative z-10">
                  {/* Step Number & Icon */}
                  <div className="step-icon w-20 h-20 mx-auto mb-6 bg-brand-100 rounded-full flex items-center justify-center">
          ...
          <div className="bg-bg-200 rounded-xl p-8 mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-16 h-16 bg-brand-100 rounded-lg mx-auto mb-3 flex items-center justify-center">
