...
const ProcessSidebar: React.FC = () => {
  const steps = [
    { num: 1, label: "Objekttyp wählen" },
    { num: 2, label: "Daten eingeben" },
    { num: 3, label: "Fotos hochladen" },
    { num: 4, label: "Zahlung & fertig" },
  ];
    ...
    <aside className="process-sidebar">
      ...
      <div>
        ...
        <div className="quote-box mb-3">
          &quot;Das Gutachten hat uns vor einem teuren Fehler bewahrt.&quot;
        </div>

        {/* Attribution */}
        <p className="text-sm text-text-300 mb-4">
          — Michael B., Familienvater
        </p>
