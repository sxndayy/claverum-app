...
const StartServicesSection: React.FC = () => {
      ...
      <section id="leistungen" className="bg-background py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto">
            {/* Report Preview + Contents Grid */}
            <div className="grid lg:grid-cols-2 gap-12 mb-16">
              {/* Left: Report Page Preview (Mockup — will be replaced with real images) */}
...
export default StartServicesSection;
