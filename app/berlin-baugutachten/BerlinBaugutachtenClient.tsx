...
// Fake Berlin testimonials
const berlinReviews: Review[] = [
  {
    rating: 5,
    reviewer: "Anna M.",
    roleReviewer: "Käuferin aus Prenzlauer Berg",
    review: "Die digitale Bauschadensanalyse hat mir geholfen, ein Gründerzeithaus in Prenzlauer Berg sicher zu kaufen. Der Bericht war sehr detailliert und zeigte mir versteckte Mängel, die ich übersehen hätte.",
    date: "Oktober 2025"
  },
  {
    rating: 5,
    reviewer: "Michael K.",
    roleReviewer: "Käufer aus Charlottenburg",
    review: "Schnelle und professionelle Bewertung meiner Wunschimmobilie in Charlottenburg. Dank der Analyse konnte ich den Kaufpreis erfolgreich nachverhandeln. Sehr empfehlenswert!",
    date: "September 2025"
  },
  {
    rating: 4.5,
    reviewer: "Sarah L.",
    roleReviewer: "Erstkäuferin aus Friedrichshain",
    review: "Als Erstkäuferin war ich überfordert. Bauklar.org hat mir geholfen, die Risiken meiner Traumwohnung in Friedrichshain richtig einzuschätzen. Der Bericht war verständlich und hilfreich.",
    date: "November 2025"
  }
];
...
const faqItems = [
  {
    ...
    answer: "Alle Gebäudetypen werden analysiert: Gründerzeithäuser in Prenzlauer Berg oder Charlottenburg, Nachkriegsbauten in Steglitz, Immobilien aus den 1950 bis 1970er Zeiten sowie Neubauten. Jeder Gebäudetyp hat spezifische Risiken, die in der Analyse berücksichtigt werden."
  },
  {
  ...
  },
  {
    ...
    answer: "Die Preise sind transparent auf der Website einsehbar und gelten deutschlandweit einheitlich. Es gibt keine versteckten Kosten oder Zusatzgebühren für Berlin. Ab 350€ inkl. MwSt."
  },
  {
...
export default function BerlinBaugutachtenClient() {
  ...
  const checkedItems = [
    {
      ...
      description: 'Wände, Decken, Fundamente'
    },
    {
      icon: Building,
      title: 'Dach & Fassade',
      description: 'Dachzustand, Dämmung, Fassadenschäden'
    },
    {
      icon: Wrench,
      title: 'Haustechnik',
      description: 'Heizung, Elektrik, Sanitär'
    },
    {
      icon: AlertTriangle,
      title: 'Feuchtigkeit & Schimmel',
      description: 'Keller, Wände, Bäder'
    }
  ];
        ...
        <main>
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="max-w-4xl mx-auto text-center">
                <h1 className="text-3xl md:text-5xl font-bold text-text-100 mb-6 hero-title">
                  Haus kaufen in Berlin? Teure Mängel entdecken, bevor Sie unterschreiben
                </h1>
                
                <p className="text-xl md:text-2xl text-text-200 mb-8 max-w-3xl mx-auto leading-relaxed">
                  Sie möchten in Berlin ein Haus kaufen und wollen keine bösen Überraschungen erleben. 
                  Verhindern Sie teure Mängel und treffen Sie Ihre Entscheidung mit Sicherheit.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                  <Card className="border-0 shadow-soft hover-lift">
                    <CardContent className="p-6">
                      ...
                      <p className="text-text-200">
                        Von Gründerzeithäusern in Prenzlauer Berg bis zu Immobilien aus den 1950 bis 1970er Zeiten – 
                        jeder Gebäudetyp hat spezifische Risiken, die professionell bewertet werden müssen.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-0 shadow-soft hover-lift">
                    <CardContent className="p-6">
                      ...
                      <p className="text-text-200">
                        Die Teilung der Stadt bis 1990 führte zu unterschiedlichen Bautraditionen. 
                        Eine fundierte Einschätzung hilft, verdeckte Mängel zu erkennen.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-0 shadow-soft hover-lift">
                    <CardContent className="p-6">
                      ...
                      <p className="text-text-200">
                        Im dynamischen Berliner Immobilienmarkt müssen Kaufentscheidungen schnell getroffen werden. 
                  ...
                  <Card className="border-0 shadow-soft hover-lift">
                    <CardContent className="p-6">
                      ...
                      <p className="text-text-200">
                        Objektive Einschätzung durch qualifizierte Sachverständige – 
                        ohne Interessenskonflikte, transparent und verlässlich.
                      </p>
                    </CardContent>
                  </Card>
                </div>

                {/* Image - Using berlin.jpg again or could use Berlin 2.jpg or Berlin 3.jpg */}
                <div className="rounded-lg overflow-hidden shadow-soft">
                  <Image
                    src="/Berlin 2.jpg"
                    alt="Berlin Gebäude – Bauschadensanalyse für Immobilien in Berlin"
                    width={1600}
                    height={900}
                    className="w-full h-auto object-cover"
                  />
          ...
          <section className="py-20 bg-background">
            <div className="container mx-auto px-4">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold text-text-100 mb-4">
                  Was Berliner Kunden sagen
                </h2>
                <p className="text-xl text-text-200 max-w-2xl mx-auto">
                  Erfahrungen von Immobilienkäufern aus Berlin
                </p>
              </div>

              <div className="max-w-4xl mx-auto">
                <ClientReviews reviews={berlinReviews} />
              </div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-4">
                  ...
                  >
                    Jetzt Risiko prüfen – Haus ohne böse Überraschung kaufen
                  </Button>
                  <Button
                    onClick={() => scrollToSection('so-funktioniert')}
                    size="lg"
